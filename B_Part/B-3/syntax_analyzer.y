...
declaration:
    ...
    keyword_val var {if($1 != 1 && $1 != 13) yyerror("Invalid declaration type"); else {cor_expr++;printf("Valid Declaration\n");}} // 1, 13 int, float, double
    ...
    | keyword_val var oper_val arr {
        ...
        else if ($1 != 1 && $1 != 13 || $3 != 12) yyerror("Invalid declaration type"); else {cor_expr++;printf("Valid Declaration\n");}}
...
assignment:
    ...
    | help_var oper_val help_arr      {
        ...
        else if($2 != 12 || var_com != val_arr_com) 
...
scan_len_print: 
    ...
    | keyword_val OPEN_PARENTHESIS str CLOSE_PARENTHESIS  { if ($1 != 4 && $1 != 6) yyerror("Invalid function call"); else {printf("Valid function call\n"); cor_expr++;}}
    ;
...
cmp_print: 
    keyword_val OPEN_PARENTHESIS help_2args CLOSE_PARENTHESIS {if ($1 != 5 && $1 != 6) yyerror("Invalid function call"); else {printf("Valid function call\n"); cor_expr++;}}
    ;

// Rules for the print function when the nubmer of parameters is 3.
print: 
    keyword_val   OPEN_PARENTHESIS scan_len_print CLOSE_PARENTHESIS {if ($1 != 6 && $3 == 4) yyerror("Invalid function call"); else {printf("Valid function call\n"); cor_expr++;}}
    | keyword_val OPEN_PARENTHESIS cmp_print CLOSE_PARENTHESIS      {if ($1 != 6 && $3 == 5) yyerror("Invalid function call"); else {printf("Valid function call\n"); cor_expr++;}}
    | keyword_val OPEN_PARENTHESIS help_3args CLOSE_PARENTHESIS     {if ($1 != 6) yyerror("Invalid function call"); else {printf("Valid function call\n"); cor_expr++;}} 
    | keyword_val OPEN_PARENTHESIS keyword_val var CLOSE_PARENTHESIS  { 
        if ($1 != 3 && $1 != 4 && $1 != 6)
...
func_call:
    ...
    | var OPEN_PARENTHESIS var CLOSE_PARENTHESIS        {printf("Valid function call\n"); cor_expr++;} // function call with a variable as a parameter
    | var OPEN_PARENTHESIS num CLOSE_PARENTHESIS        {printf("Valid function call\n"); cor_expr++;} // function call with 1 num parameter
    | var OPEN_PARENTHESIS str CLOSE_PARENTHESIS        {printf("Valid function call\n"); cor_expr++;} // function call with 1 str parameter
    | var OPEN_PARENTHESIS help_2args CLOSE_PARENTHESIS {printf("Valid function call\n"); cor_expr++;} // function call with 2 parameters
    | var OPEN_PARENTHESIS help_3args CLOSE_PARENTHESIS {printf("Valid function call\n"); cor_expr++;} // function call with 3 parameters or more
    | var OPEN_PARENTHESIS CLOSE_PARENTHESIS            {printf("Valid function call\n"); cor_expr++;} // function call with no parameters
    ;
...
if_while_grammar:
    ...
    | if_while_grammar keyword_val cond_body {if ($2 != 9 || $1 != 8) yyerror("Invalid if/while statement"); else {printf("Valid else statement\n"); cor_expr++;}}
    | if_while_grammar END keyword_val cond_body {if ($3 != 9 || $1 != 8) yyerror("Invalid if/while statement"); else {printf("Valid else statement\n");cor_expr++;}}
    ;
