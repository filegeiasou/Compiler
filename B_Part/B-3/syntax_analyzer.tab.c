...
#line 118 "syntax_analyzer.y"
              { (yyval.sval) = strdup(yytext);}
#line 1422 "syntax_analyzer.tab.c"
    break;
...
#line 1473 "syntax_analyzer.tab.c"
    break;
...
#line 1525 "syntax_analyzer.tab.c"
    break;
...
#line 376 "syntax_analyzer.y"
                                      {if((yyvsp[-1].ival) != 12 || var_com != val_com)     yyerror("Invalid assignment"); else {cor_expr++;printf("Valid assignment");} var_com = 0; val_com = 0; }
...
#line 394 "syntax_analyzer.y"
                                      {if((yyvsp[-1].ival) != 12 || var_com != val_ass_com) yyerror("Invalid assignment"); else {cor_expr++;printf("Valid assignment");} var_com = 0; val_ass_com = 0; }
...
#line 2089 "syntax_analyzer.tab.c"
    break;
...
#line 2122 "syntax_analyzer.tab.c"
  ...
  case 163: /* for_grammar: keyword_val OPEN_PARENTHESIS help_for DELIMITER expr DELIMITER help_for CLOSE_PARENTHESIS cond_body  */
#line 571 "syntax_analyzer.y"
                                                                                                              {if((yyvsp[-8].ival) != 11) yyerror("Invalid for statement"); else cor_expr++;}
#line 2128 "syntax_analyzer.tab.c"
    break;

  case 164: /* for_grammar: keyword_val OPEN_PARENTHESIS help_for DELIMITER var_oper DELIMITER help_for CLOSE_PARENTHESIS cond_body  */
...
#line 2138 "syntax_analyzer.tab.c"
